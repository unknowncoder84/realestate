...
export default function InsightsPage() {
  return (
    <>
      {/* Hero */}
      <section className="relative min-h-[60vh] flex flex-col justify-center pt-32 pb-20 px-6 overflow-hidden">
        <HeroVideo />
        <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[984px] h-[527px] opacity-90 bg-[#030712] blur-[82px] pointer-events-none z-[2]" />

        <div className="relative z-10 max-w-[88rem] mx-auto w-full">
          <span className="text-[#C8A87E]/60 text-sm font-medium uppercase tracking-wider mb-4 block">Insights & Research</span>
      ...
      <section className="px-6 pb-12">
        <div className="max-w-[88rem] mx-auto">
          <div className="glass-card rounded-3xl p-10 md:p-14 glow-gold-sm group cursor-pointer">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-10 items-center">
              <div>
                ...
                <p className="text-white/45 text-base leading-relaxed mb-6">{featuredArticle.excerpt}</p>
                <div className="flex items-center gap-4">
                  <span className="inline-flex items-center gap-3 text-[#C8A87E] text-sm font-medium group-hover:gap-4 transition-all">
                    Read Article
        ...
        <div className="max-w-[88rem] mx-auto">
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
            {articles.map((article, i) => {
              ...
              return (
                <div key={i} className="glass-card rounded-2xl p-8 flex flex-col justify-between min-h-[320px] group cursor-pointer">
                  <div>
                    ...
                    <h3
                      className="text-white text-lg font-medium mb-3 leading-snug"

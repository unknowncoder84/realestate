    ...
    <>
      ...
      <section className="relative pt-32 pb-20 px-6">
        ...
        <div className="max-w-[88rem] mx-auto">
          <span className="text-[#C8A87E]/60 text-sm font-medium uppercase tracking-wider mb-4 block">Contact Us</span>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-5 gap-8">
            ...
            <div className="lg:col-span-2 space-y-6">
              <div className="glass-card rounded-2xl p-7">
                <div className="flex items-start gap-4">
                  <div className="w-10 h-10 rounded-xl glass flex items-center justify-center shrink-0">
                    <Mail className="w-4 h-4 text-[#C8A87E]" />
                  </div>
                  <div>
                    <h3 className="text-white font-medium text-sm mb-1" style={{ letterSpacing: '-0.01em' }}>Email</h3>
                    <p className="text-white/40 text-sm">advisory@elitefinance.com</p>
                    <p className="text-white/30 text-xs mt-1">For new client inquiries</p>
                  </div>
                </div>
              </div>
              ...
              <div className="glass-card rounded-2xl p-7">
                <div className="flex items-start gap-4">
                  <div className="w-10 h-10 rounded-xl glass flex items-center justify-center shrink-0">
                    <Phone className="w-4 h-4 text-[#C8A87E]" />
                  </div>
                  <div>
                    <h3 className="text-white font-medium text-sm mb-1" style={{ letterSpacing: '-0.01em' }}>Phone</h3>
                    <p className="text-white/40 text-sm">+1 (212) 555-0123</p>
                    <p className="text-white/30 text-xs mt-1">Mon–Fri, 9AM–6PM ET</p>
                  </div>
                </div>
              </div>
              ...
              <div className="glass-card rounded-2xl p-7">
                <div className="flex items-start gap-4">
                  <div className="w-10 h-10 rounded-xl glass flex items-center justify-center shrink-0">
                    <Clock className="w-4 h-4 text-[#C8A87E]" />
                  </div>
                  <div>
                    <h3 className="text-white font-medium text-sm mb-1" style={{ letterSpacing: '-0.01em' }}>Response Time</h3>
                    <p className="text-white/40 text-sm">Within 24 hours</p>
                    <p className="text-white/30 text-xs mt-1">Urgent matters prioritized</p>
                  </div>
                </div>
              </div>
                ...
                <form onSubmit={handleSubmit} className="space-y-5">
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
                    <div>
                      ...
                      <input type="text" id="firstName" name="firstName" value={formData.firstName} onChange={handleChange} required className="w-full px-4 py-3 rounded-xl glass-input text-white text-sm placeholder-white/25" placeholder="John" />
                    </div>
                    <div>
                      <label htmlFor="lastName" className="block text-white/60 text-xs font-medium mb-2 uppercase tracking-wider">Last Name</label>
                      <input type="text" id="lastName" name="lastName" value={formData.lastName} onChange={handleChange} required className="w-full px-4 py-3 rounded-xl glass-input text-white text-sm placeholder-white/25" placeholder="Anderson" />
                    </div>
                  </div>
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
                    <div>
                      ...
                      <input type="email" id="email" name="email" value={formData.email} onChange={handleChange} required className="w-full px-4 py-3 rounded-xl glass-input text-white text-sm placeholder-white/25" placeholder="john@company.com" />
                    </div>
                    <div>
                      <label htmlFor="phone" className="block text-white/60 text-xs font-medium mb-2 uppercase tracking-wider">Phone</label>
                      <input type="tel" id="phone" name="phone" value={formData.phone} onChange={handleChange} className="w-full px-4 py-3 rounded-xl glass-input text-white text-sm placeholder-white/25" placeholder="+1 (212) 555-0000" />
                    </div>
                  </div>
                  ...
                  <div>
                    ...
                    <input type="text" id="company" name="company" value={formData.company} onChange={handleChange} className="w-full px-4 py-3 rounded-xl glass-input text-white text-sm placeholder-white/25" placeholder="Company name" />
                  </div>
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
                    <div>
                      ...
                      <select id="service" name="service" value={formData.service} onChange={handleChange} required className="w-full px-4 py-3 rounded-xl glass-input text-white text-sm bg-transparent">
                    ...
                    <div>
                      ...
                      <select id="investmentRange" name="investmentRange" value={formData.investmentRange} onChange={handleChange} className="w-full px-4 py-3 rounded-xl glass-input text-white text-sm bg-transparent">
                  ...
                  <div>
                    ...
                    <textarea id="message" name="message" value={formData.message} onChange={handleChange} rows={4} className="w-full px-4 py-3 rounded-xl glass-input text-white text-sm placeholder-white/25 resize-none" placeholder="Tell us about your financial goals and how we can help..." />
                  </div>

                  <button
                    type="submit"
                    className="w-full inline-flex items-center justify-center gap-3 py-3.5 rounded-full bg-gradient-to-r from-[#C8A87E] to-[#B8956A] text-[#060611] text-base font-medium hover:shadow-lg hover:shadow-[#C8A87E]/20 transition-all duration-300"
                  >
                    Submit Inquiry
      ...
      <section className="px-6 pb-24">
        <div className="max-w-[88rem] mx-auto">
          <div className="text-center mb-14">
            <span className="text-[#C8A87E]/60 text-sm font-medium uppercase tracking-wider mb-3 block">Global Presence</span>
            <h2
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
            {offices.map((office, i) => (
              <div key={i} className="glass-card rounded-2xl p-7 min-h-52 flex flex-col justify-between">
                <div className="flex items-start gap-3 mb-4">
                  <div className="w-8 h-8 rounded-lg glass flex items-center justify-center shrink-0">
                    <MapPin className="w-3.5 h-3.5 text-[#C8A87E]" />
                  </div>
                  <h3 className="text-white text-lg font-medium" style={{ letterSpacing: '-0.02em' }}>
                    {office.city}
                  </h3>
                </div>
                <div className="space-y-2">
                  <p className="text-white/40 text-sm whitespace-pre-line leading-relaxed">{office.address}</p>
